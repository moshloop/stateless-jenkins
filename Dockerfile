...
RUN pip install ansible==$ANSIBLE_VERSION ansible-run ansible-provision==${ANSIBLE_PROVISION_VER} ansible-deploy ansible-dependencies[all] openpyxl pandas sh
